...
<AssetObjects..TextureInstance>
	...
	<m_CookParams>
		<m_Values>
			<Element class="AssetObjects..FloatValue">
				<m_fValue>12.5</m_fValue>
				<m_ParamName text="HeightScale"/>
			</Element>
			<Element class="AssetObjects..FloatValue">
				<m_fValue>224</m_fValue>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\NW\LakeVictoria\Lake_Victoria_HM_3.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1148415621</m_ExportedTime>
	<m_ClassName text="TerrainElementHeightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Lake_Victoria_HM_3.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Lake_Victoria_HM_3"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
