...
<AssetObjects..TextureInstance>
	...
	<m_CookParams>
		<m_Values>
			<Element class="AssetObjects..FloatValue">
				<m_fValue>9.2</m_fValue>
				<m_ParamName text="HeightScale"/>
			</Element>
			<Element class="AssetObjects..FloatValue">
				<m_fValue>209</m_fValue>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\NW\LakeVictoria\Lake_Victoria_HM_2.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3559396902</m_ExportedTime>
	<m_ClassName text="TerrainElementHeightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Lake_Victoria_HM_2.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Lake_Victoria_HM_2"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
