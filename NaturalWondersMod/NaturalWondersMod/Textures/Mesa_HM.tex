...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\Terrain\NW\Mesa\Mesa_HM.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>340708185</m_ExportedTime>
	<m_ClassName text="TerrainElementHeightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Mesa_HM.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Mesa_HM"/>
	<m_Description text=""/>
