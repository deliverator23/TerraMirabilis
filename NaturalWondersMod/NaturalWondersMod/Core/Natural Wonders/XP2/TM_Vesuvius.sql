...
VALUES	('MODIFIER_TM_FEATURE_VESUVIUS_ATTACH_ANTIQUITY',			'MODTYPE_TM_ATTACH_ALL_PLAYERS',		'REQSET_TM_PLAYER_HAS_FEATURE_VESUVIUS'	),
		('MODIFIER_TM_FEATURE_VESUVIUS_ANTIQUITY',					'MODTYPE_TM_ADJUST_PLAYER_PLOT_YIELD',	'REQSET_TM_PLOT_HAS_ANTIQUITY'			),
		('MODIFIER_TM_FEATURE_VESUVIUS_ATTACH_ARTIFACT_CULTURE',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',		'REQSET_TM_PLAYER_HAS_FEATURE_VESUVIUS'	),
		('MODIFIER_TM_FEATURE_VESUVIUS_ARTIFACT_CULTURE',			'MODTYPE_TM_PLAYER_GW_YIELD',			NULL									),
		('MODIFIER_TM_FEATURE_VESUVIUS_ATTACH_ARTIFACT_TOURISM',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',		'REQSET_TM_PLAYER_HAS_FEATURE_VESUVIUS'	),
		('MODIFIER_TM_FEATURE_VESUVIUS_ARTIFACT_TOURISM',			'MODTYPE_TM_PLAYER_GW_TOURISM',			NULL									);
