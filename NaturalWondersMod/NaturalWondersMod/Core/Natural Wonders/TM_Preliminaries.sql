...
VALUES	-- ATTACH
		...
		-- UNIT
		('MODTYPE_TM_INITIATION_YIELD',				'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_INITIATION_YIELD'						),
		('MODTYPE_TM_ADJUST_UNIT_HEALING',			'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_HEALING_MODIFIERS'						),
		('MODTYPE_TM_ADJUST_UNIT_STRENGTH',			'COLLECTION_UNIT_COMBAT',			'EFFECT_ADJUST_PLAYER_STRENGTH_MODIFIER'					),
		('MODTYPE_TM_ADJUST_UNIT_MOVEMENT',			'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_MOVEMENT'								),
		('MODTYPE_TM_ADJUST_UNIT_SIGHT',			'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_SIGHT'									),
		('MODTYPE_TM_ADJUST_UNIT_SPREAD',			'COLLECTION_PLAYER_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_SPREAD_CHARGES'							),
		('MODTYPE_TM_ADJUST_UNIT_IGNORE_TERRAIN',	'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_IGNORE_TERRAIN_COST'					),
