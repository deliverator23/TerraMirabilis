...
SELECT	'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_CAMPUS',		'MODTYPE_TM_ATTACH_ALL_CITIES',	'REQSET_TM_CITY_HAS_FEATURE_ZHANGYE_DANXIA'
WHERE EXISTS (SELECT * FROM Features WHERE FeatureType = 'FEATURE_ZHANGYE_DANXIA');
	
INSERT INTO Modifiers
		(ModifierId,													ModifierType,					SubjectRequirementSetId	)
SELECT	'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_COMMERCIAL',	'MODTYPE_TM_ATTACH_ALL_CITIES',	'REQSET_TM_CITY_HAS_FEATURE_ZHANGYE_DANXIA'
WHERE EXISTS (SELECT * FROM Features WHERE FeatureType = 'FEATURE_ZHANGYE_DANXIA');
		
INSERT INTO Modifiers
		(ModifierId,											ModifierType,							SubjectRequirementSetId					)
VALUES	('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_CAMPUS',		'MODTYPE_TM_ADJUST_CITY_DISTRICTS_GP',	'REQSET_TM_DISTRICT_IS_CAMPUS'			),
		('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_COMMERCIAL',	'MODTYPE_TM_ADJUST_CITY_DISTRICTS_GP',	'REQSET_TM_DISTRICT_IS_COMMERCIAL_HUB'	);
...
SELECT	'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_CAMPUS',		'ModifierId',	'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_CAMPUS'
WHERE EXISTS (SELECT * FROM Features WHERE FeatureType = 'FEATURE_ZHANGYE_DANXIA');

INSERT INTO ModifierArguments
		(ModifierId,													Name,			Value	)
SELECT	'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_COMMERCIAL',	'ModifierId',	'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_COMMERCIAL'
WHERE EXISTS (SELECT * FROM Features WHERE FeatureType = 'FEATURE_ZHANGYE_DANXIA');
