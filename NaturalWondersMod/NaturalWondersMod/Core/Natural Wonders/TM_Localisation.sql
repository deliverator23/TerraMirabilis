...
-----------------------------------------------
	...
	("LOC_FEATURE_BARRINGER_CRATER_NAME",				"Barringer Crater"	),
	("LOC_TM_FEATURE_BARRINGER_CRATER_DESCRIPTION",		"One tile natural wonder. Yields +3 [ICON_Science] Science and +2 [ICON_Gold] Gold."	),
	("LOC_TM_FEATURE_BARRINGER_CRATER_EFFECT_DESCRIPTION",	"One tile natural wonder. Yields +3 [ICON_Science] Science and +2 [ICON_Gold] Gold.[NEWLINE][NEWLINE]Receive +20% [ICON_Production] Production toward Space Race projects in the City that owns this tile."	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_BARRINGER_CRATER_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_CLIFFS_DOVER_DESCRIPTION",				"Two tile natural wonder. Appears as Cliffs. Yields +3 [ICON_Culture] Culture, +1 [ICON_Food] Food, and +1 [ICON_Gold] Gold."	),
	("LOC_TM_FEATURE_CLIFFS_DOVER_EFFECT_DESCRIPTION",		"Two tile natural wonder. Appears as Cliffs. Yields +3 [ICON_Culture] Culture, +1 [ICON_Food] Food, and +1 [ICON_Gold] Gold.[NEWLINE][NEWLINE]Harbors receive minor adjacency bonuses from Cliffs for any Civilization that owns at least one of these tiles."	),

	("LOC_MODIFIER_TM_FEATURE_CLIFFS_DOVER_ADJACENCY_DESCRIPTION",	"+{1_num} [ICON_Gold] Gold from adjacent {1_Num : plural 1?cliff; other?cliffs;}."	),
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_DEAD_SEA_DESCRIPTION",				"Two tile natural wonder. Appears as a Lake. Yields +2 [ICON_Faith] Faith, +2 [ICON_Culture] Culture, and +1 [ICON_Gold] Gold."	),
	("LOC_TM_FEATURE_DEAD_SEA_EFFECT_DESCRIPTION",		"Two tile natural wonder. Appears as a Lake. Yields +2 [ICON_Faith] Faith, +2 [ICON_Culture] Culture, and +1 [ICON_Gold] Gold.[NEWLINE][NEWLINE]Units trained in a City that owns at least one of these tiles may heal an additional 10 HP when [ICON_Fortified] Fortified."	),

-----------------------------------------------
-- DELICATE ARCH
-----------------------------------------------

	("LOC_TM_FEATURE_DELICATE_ARCH_DESCRIPTION",		"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_Faith] Faith, +1 [ICON_Science] Science, and +1 [ICON_Culture] Culture."	),
	("LOC_TM_FEATURE_DELICATE_ARCH_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_Faith] Faith, +1 [ICON_Science] Science, and +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Plots are 20% cheaper to purchase for any Civilization that owns this tile."	),

-----------------------------------------------
-- EVEREST
-----------------------------------------------

	("LOC_TM_FEATURE_EVEREST_DESCRIPTION",			"Three tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Faith] Faith."	),
	("LOC_TM_FEATURE_EVEREST_EFFECT_DESCRIPTION",	"Three tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Faith] Faith.[NEWLINE][NEWLINE]Religious units trained in any City that owns at least one of these tiles ignore [ICON_Movement] Movement penalties on Hills and receive +1 additional spread charge."	),

-----------------------------------------------
-- EYE OF THE SAHARA
-----------------------------------------------

	("LOC_TM_FEATURE_EYE_OF_THE_SAHARA_DESCRIPTION",		"Three tile natural wonder. Yields +2 [ICON_PRODUCTION] Production, +2 [ICON_Science] Science, and +1 [ICON_Gold] Gold."	),
	("LOC_TM_FEATURE_EYE_OF_THE_SAHARA_EFFECT_DESCRIPTION",	"Three tile natural wonder. Yields +2 [ICON_PRODUCTION] Production, +2 [ICON_Science] Science, and +1 [ICON_Gold] Gold.[NEWLINE][NEWLINE]Any Civilization that owns at least one of these tiles receives +2 Era Score from Historic Moments if that Moment is usually worth at least +4 Era Score."	),
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_GALAPAGOS_DESCRIPTION",		"Two tile impassable natural wonder. Adjacent plots yield +2 [ICON_Science] Science."	),
	("LOC_TM_FEATURE_GALAPAGOS_EFFECT_DESCRIPTION",	"Two tile impassable natural wonder. Adjacent plots yield +2 [ICON_Science] Science.[NEWLINE][NEWLINE]Grants a free copy of the [ICON_RESOURCE_TM_TORTOISE] Tortoise luxury resource (not tradeable), which provides +6 [ICON_Amenities] Amenities, to any Civilization that owns at least one of these tiles."	),
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_GIANTS_CAUSEWAY_DESCRIPTION",			"Two tile impassable natural wonder. Adjacent plots yield +2 [ICON_Culture] Culture."	),
	("LOC_TM_FEATURE_GIANTS_CAUSEWAY_EFFECT_DESCRIPTION",	"Two tile impassable natural wonder. Adjacent plots yield +2 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Land units trained in a City that owns at least one of these tiles start with a free [ICON_Promotion] Promotion."	),

-----------------------------------------------
-- GRAND MESA
-----------------------------------------------

	("LOC_FEATURE_GRAND_MESA_NAME",						"Grand Mesa"	),
	("LOC_TM_FEATURE_GRAND_MESA_DESCRIPTION",			"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_Food] Food and +1 [ICON_Culture] Culture."	),
	("LOC_TM_FEATURE_GRAND_MESA_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_Food] Food and +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Units trained in the City that owns this tile ignore [ICON_Movement] Movement penalties in Forest or Jungle."	),
...
-----------------------------------------------
	...
	("LOC_FEATURE_KAILASH_NAME",					"Mount Kailash"	),
	("LOC_TM_FEATURE_KAILASH_DESCRIPTION",			"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Faith] Faith and +1 [ICON_Culture] Culture."	),
	("LOC_TM_FEATURE_KAILASH_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Faith] Faith and +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Receive +1 [ICON_Culture] Culture for every foreign City that follows the [ICON_Religion] Religion of the Civilization that owns this tile."	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_KAILASH_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_KILIMANJARO_DESCRIPTION",			"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Food] Food."	),
	("LOC_TM_FEATURE_KILIMANJARO_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Food] Food.[NEWLINE][NEWLINE]Receive +1 [ICON_Citizen] Population in the City that owns this tile when a Specialty District is constructed."	),

-----------------------------------------------
-- KRAKATOA
-----------------------------------------------

	("LOC_FEATURE_KRAKATOA_NAME",						"Krakatoa"	),
	("LOC_TM_FEATURE_KRAKATOA_DESCRIPTION",				"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Science] Science and +1 [ICON_Culture] Culture."	),
	("LOC_TM_FEATURE_KRAKATOA_EFFECT_DESCRIPTION",		"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Science] Science and +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Receive +2 [ICON_Science] Science for each Specialty District in a City that owns this tile, increasing to +3 if the City has a National Park."	),
	("LOC_TM_FEATURE_KRAKATOA_EFFECT_XP1_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Science] Science and +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Any Civilization that owns this tile receives a free [ICON_TechBoosted] Eureka upon earning a [ICON_GreatAdmiral] Great Admiral."	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_KRAKATOA_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_LAKE_RETBA_DESCRIPTION",			"Two tile natural wonder. Appears as a Lake. Yields +2 [ICON_CULTURE] Culture, +2 [ICON_GOLD] Gold, +1 [ICON_PRODUCTION] Production."	),
	("LOC_TM_FEATURE_LAKE_RETBA_EFFECT_DESCRIPTION",	"Two tile natural wonder. Appears as a Lake. Yields +2 [ICON_CULTURE] Culture, +2 [ICON_GOLD] Gold, +1 [ICON_PRODUCTION] Production.[NEWLINE][NEWLINE]Any Civilization that owns at least one of these tiles receives +2 [ICON_Gold] Gold for each unique copy of a Luxury resource that they own."	),
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_MATTERHORN_DESCRIPTION",			"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_CULTURE] Culture to adjacent tiles."	),
	("LOC_TM_FEATURE_MATTERHORN_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_CULTURE] Culture to adjacent tiles.[NEWLINE][NEWLINE]Land Units trained in a City that owns this tile ignore [ICON_Movement] Movement penalties on Hills, and receive +3 [ICON_Strength] Combat Strength when fighting on them."	),

	("LOC_MODIFIER_TM_FEATURE_MATTERHORN_COMBAT_DESCRIPTION",		"+{1_Amount} Combat Bonus on Hills (Matterhorn)"	),

-----------------------------------------------
-- MOTLATSE CANYON
-----------------------------------------------

	("LOC_FEATURE_MOTLATSE_CANYON_NAME",				"Motlatse Canyon"	),
	("LOC_TM_FEATURE_MOTLATSE_CANYON_DESCRIPTION",			"Four tile impassable natural wonder. Adjacent plots yield +1 [ICON_Culture] Culture and +1 [ICON_Science] Science."	),
	("LOC_TM_FEATURE_MOTLATSE_CANYON_EFFECT_DESCRIPTION",	"Four tile impassable natural wonder. Adjacent plots yield +1 [ICON_Culture] Culture and +1 [ICON_Science] Science.[NEWLINE][NEWLINE]Specialty Districts receive +1 of their respective yield on Breathtaking plots for any Civilization that owns at least one of these tiles."	),
	
	("LOC_ADJ_MOTLATSE_FAITH_DESCRIPTION",				"+{1_num} [ICON_Faith] Faith from the tile's Appeal. (Motlatse Canyon)"	),
	("LOC_ADJ_MOTLATSE_SCIENCE_DESCRIPTION",			"+{1_num} [ICON_Science] Science from the tile's Appeal. (Motlatse Canyon)"	),
	("LOC_ADJ_MOTLATSE_CULTURE_DESCRIPTION",			"+{1_num} [ICON_Culture] Culture from the tile's Appeal. (Motlatse Canyon)"	),
	("LOC_ADJ_MOTLATSE_PRODUCTION_DESCRIPTION",			"+{1_num} [ICON_Production] Production from the tile's Appeal. (Motlatse Canyon)"	),
	("LOC_ADJ_MOTLATSE_GOLD_DESCRIPTION",				"+{1_num} [ICON_Gold] Gold from the tile's Appeal. (Motlatse Canyon)"	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_MOTLATSE_CANYON_CHAPTER_HISTORY_PARA_1",	
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_MOTLATSE_CANYON_CHAPTER_HISTORY_PARA_2",	
...
-----------------------------------------------
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_OLD_FAITHFUL_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_PIOPIOTAHI_DESCRIPTION",			"Three tile impassable natural wonder. Adjacent plots yield +1 [ICON_Culture] Culture and +1 [ICON_Gold] Gold."	),
	("LOC_TM_FEATURE_PIOPIOTAHI_EFFECT_DESCRIPTION",	"Three tile impassable natural wonder. Adjacent plots yield +1 [ICON_Culture] Culture and +1 [ICON_Gold] Gold.[NEWLINE][NEWLINE][ICON_Amenities] Amenities provided by regional buildings extend 3 tiles further for any Civilization that owns at least one of these tiles."	),
	
-----------------------------------------------
-- ROCK OF GIBRALTAR
-----------------------------------------------

	("LOC_FEATURE_GIBRALTAR_NAME",					"Rock of Gibraltar"	),
	("LOC_TM_FEATURE_GIBRALTAR_DESCRIPTION",		"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_Food] Food and +1 [ICON_Gold] Gold."	),
	("LOC_TM_FEATURE_GIBRALTAR_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_Food] Food and +1 [ICON_Gold] Gold.[NEWLINE][NEWLINE]Encampments and Harbors receive +2 [ICON_GreatPerson] Great Person Points of their respective type in the City that owns this tile."	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_GIBRALTAR_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_RORAIMA_DESCRIPTION",			"Four tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_FAITH] Faith and +1 [ICON_SCIENCE] Science."	),
	("LOC_TM_FEATURE_RORAIMA_EFFECT_DESCRIPTION",	"Four tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_FAITH] Faith and +1 [ICON_SCIENCE] Science.[NEWLINE][NEWLINE]Jungle does not diminish the appeal of adjacent plots for any Civilization that owns at least one of these tiles."	),
...
-----------------------------------------------
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_SALAR_DE_UYUNI_CHAPTER_HISTORY_PARA_1",	
	...
	("LOC_RESOURCE_TM_LITHIUM_NAME",	"Lithium"	),
	("LOC_PEDIA_RESOURCES_PAGE_RESOURCE_TM_LITHIUM_CHAPTER_HISTORY_PARA_1",
...
-----------------------------------------------
	...
	("LOC_FEATURE_SINAI_NAME",					"Mount Sinai"	),
	("LOC_TM_FEATURE_SINAI_DESCRIPTION",		"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Faith] Faith."	),
	("LOC_TM_FEATURE_SINAI_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Faith] Faith.[NEWLINE][NEWLINE]Holy Sites provide +1 [ICON_GreatPerson] Great Person Points toward [ICON_GreatProphet] Great Prophets for the player that owns this tile. Religious units trained in this City receive +10 Theological [ICON_Strength] Combat Strength."	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_SINAI_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_FEATURE_SRI_PADA_NAME",					"Sri Pada"	),
	("LOC_TM_FEATURE_SRI_PADA_DESCRIPTION",			"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Food] Food and +1 [ICON_Faith] Faith."	),
	("LOC_TM_FEATURE_SRI_PADA_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_Food] Food and +1 [ICON_Faith] Faith.[NEWLINE][NEWLINE]Religious units trained in the City that owns this tile receive [ICON_Culture] Culture upon converting a City to their [ICON_Religion] Religion for the first time."	),
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_SRI_PADA_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_UBSUNUR_HOLLOW_DESCRIPTION",			"Four tile natural wonder. Appears as Marsh. Yields +2 [ICON_FAITH] Faith, +1 [ICON_FOOD] Food, and +2 [ICON_PRODUCTION] Production."	),
	("LOC_TM_FEATURE_UBSUNUR_HOLLOW_EFFECT_DESCRIPTION",	"Four tile natural wonder. Appears as Marsh. Yields +2 [ICON_FAITH] Faith, +1 [ICON_FOOD] Food, and +2 [ICON_PRODUCTION] Production.[NEWLINE][NEWLINE]Any Civilization that owns at least one of these tiles receives a free [ICON_CivicBoosted] Inspiration upon earning a [ICON_GreatGeneral] Great General."	),

-----------------------------------------------
-- ULURU
-----------------------------------------------

	("LOC_TM_FEATURE_ULURU_DESCRIPTION",		"One tile impassable natural wonder. Adjacent plots yield +2 [ICON_CULTURE] Culture and +2 [ICON_FAITH] Faith."	),
	("LOC_TM_FEATURE_ULURU_EFFECT_DESCRIPTION",	"One tile impassable natural wonder. Adjacent plots yield +2 [ICON_CULTURE] Culture and +2 [ICON_FAITH] Faith.[NEWLINE][NEWLINE]Specialty Districts constructed on desert terrain yield +1 [ICON_Food] Food for any Civilization that owns this tile."	),
...
-----------------------------------------------
	...
	("LOC_PEDIA_FEATURES_PAGE_FEATURE_WULINGYUAN_CHAPTER_HISTORY_PARA_1",	
...
-----------------------------------------------
	...
	("LOC_TM_FEATURE_YOSEMITE_DESCRIPTION",			"Two tile impassable natural wonder. Adjacent plots yield +1 [ICON_Gold] Gold and +1 [ICON_Science] Science."	),
	("LOC_TM_FEATURE_YOSEMITE_EFFECT_DESCRIPTION",	"Two tile impassable natural wonder. Adjacent plots yield +1 [ICON_Gold] Gold and +1 [ICON_Science] Science.[NEWLINE][NEWLINE]Forest provides an additional +1 Appeal to adjacent plots for any Civilization that owns at least one of these tiles."	),

-----------------------------------------------
-- ZHANGYE DANXIA
-----------------------------------------------

	("LOC_TM_FEATURE_ZHANGYE_DANXIA_DESCRIPTION",			"Three tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Science] Science."	),
	("LOC_TM_FEATURE_ZHANGYE_DANXIA_EFFECT_DESCRIPTION",	"Three tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +2 [ICON_Science] Science.[NEWLINE][NEWLINE]Commercial Hubs and Campus districts in a City that owns at least one of these tiles receive +2 [ICON_GreatPerson] Great Person Points of their respective type."	),

-----------------------------------------------
-- MISC - District Adjacency
-----------------------------------------------

	("LOC_TM_ADJ_NW_FAITH_DESCRIPTION",			"+{1_num} [ICON_Faith] Faith from the adjacent {1_Num : plural 1?Natural Wonder; other?Natural Wonder plots;}."	),
	("LOC_TM_ADJ_NW_SCIENCE_DESCRIPTION",		"+{1_num} [ICON_Science] Science from the adjacent {1_Num : plural 1?Natural Wonder; other?Natural Wonder plots;}."	),
	("LOC_TM_ADJ_NW_CULTURE_DESCRIPTION",		"+{1_num} [ICON_Culture] Culture from the adjacent {1_Num : plural 1?Natural Wonder; other?Natural Wonder plots;}."	),
	("LOC_TM_ADJ_NW_PRODUCTION_DESCRIPTION",	"+{1_num} [ICON_Production] Production from the adjacent {1_Num : plural 1?Natural Wonder; other?Natural Wonder plots;}."	),
	("LOC_TM_ADJ_NW_GOLD_DESCRIPTION",			"+{1_num} [ICON_Gold] Gold from the adjacent {1_Num : plural 1?Natural Wonder; other?Natural Wonder plots;}."	),
