...
VALUES	('MODIFIER_TM_FEATURE_MATTERHORN_ATTACH_PLAYERS_MOVEMENT',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',			'REQSET_TM_PLAYER_HAS_FEATURE_MATTERHORN'	),
		('MODIFIER_TM_FEATURE_MATTERHORN_ATTACH_PLAYERS_COMBAT',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',			'REQSET_TM_PLAYER_HAS_FEATURE_MATTERHORN'	),
		('MODIFIER_TM_FEATURE_MATTERHORN_MOVEMENT',					'MODTYPE_TM_ADJUST_UNIT_IGNORE_TERRAIN',	'REQSET_TM_UNIT_IS_LAND'					),
...
VALUES	('MODIFIER_TM_FEATURE_MATTERHORN_ATTACH_PLAYERS_MOVEMENT',	'ModifierId',	'MODIFIER_TM_FEATURE_MATTERHORN_MOVEMENT'		),
		('MODIFIER_TM_FEATURE_MATTERHORN_ATTACH_PLAYERS_COMBAT',	'ModifierId',	'MODIFIER_TM_FEATURE_MATTERHORN_COMBAT_ATTACH'	),
		('MODIFIER_TM_FEATURE_MATTERHORN_COMBAT_ATTACH',			'ModifierId',	'MODIFIER_TM_FEATURE_MATTERHORN_COMBAT'			),
