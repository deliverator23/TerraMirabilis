...
VALUES	('MODIFIER_TM_FEATURE_EYJAFJALLAJOKULL_ATTACH_PLAYERS',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',	'REQSET_TM_PLAYER_HAS_FEATURE_EYJAFJALLAJOKULL'	),
		('MODIFIER_TM_FEATURE_EYJAFJALLAJOKULL_SNOW_FOOD',		'MODTYPE_TM_PLAYER_DISTRICT_YIELD',	'REQSET_TM_DISTRICT_IS_SPECIALTY_TUNDRA'		);
...
VALUES	('MODIFIER_TM_FEATURE_EYJAFJALLAJOKULL_ATTACH_PLAYERS',	'ModifierId',	'MODIFIER_TM_FEATURE_EYJAFJALLAJOKULL_SNOW_FOOD'	),
		('MODIFIER_TM_FEATURE_EYJAFJALLAJOKULL_SNOW_FOOD',		'YieldType',	'YIELD_FOOD'										),
