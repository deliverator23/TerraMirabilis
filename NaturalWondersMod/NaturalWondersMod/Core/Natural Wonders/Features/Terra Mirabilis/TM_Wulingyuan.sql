...
VALUES	('MODIFIER_TM_FEATURE_WULINGYUAN_ATTACH_PLAYERS_SLOT',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',	'REQSET_TM_PLAYER_HAS_FEATURE_WULINGYUAN'	),
		('MODIFIER_TM_FEATURE_WULINGYUAN_ATTACH_PLAYERS_YIELD',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',	'REQSET_TM_PLAYER_HAS_FEATURE_WULINGYUAN'	),
		('MODIFIER_TM_FEATURE_WULINGYUAN_GW_SLOT',				'MODTYPE_TM_BUILDING_GW_SLOT',		NULL										),
...
VALUES	('MODIFIER_TM_FEATURE_WULINGYUAN_ATTACH_PLAYERS_SLOT',	'ModifierId',			'MODIFIER_TM_FEATURE_WULINGYUAN_GW_SLOT'	),
		('MODIFIER_TM_FEATURE_WULINGYUAN_ATTACH_PLAYERS_YIELD',	'ModifierId',			'MODIFIER_TM_FEATURE_WULINGYUAN_GW_YIELD'	),
		('MODIFIER_TM_FEATURE_WULINGYUAN_GW_SLOT',				'BuildingType',			'BUILDING_AMPHITHEATER'						),
