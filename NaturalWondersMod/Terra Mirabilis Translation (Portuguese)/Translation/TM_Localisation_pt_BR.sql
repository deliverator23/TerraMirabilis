...
VALUES
	...
	("pt_BR",	"LOC_RESOURCE_TM_SYLVITE_NAME",						"Silvita",										"feminine",				"1"		);
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_DALLOL_EFFECT",				"Fornece uma cópia do recurso de luxo [ICON_RESOURCE_TM_SYLVITE] Silvita (não negociável), que fornece +6 [ICON_Amenities] de Serviços, para qualquer Civilização que possua este painel."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_LAKE_VICTORIA_DESCRIPTION",				"Maravilha natural de 4 painéis. Aparece como um Lago e fornece Água Doce. Fornece +3 de [ICON_Food] Comida, +1 de [ICON_CULTURE] Cultura, e +1 de [ICON_GOLD] Ouro."	),
	("pt_BR",	"LOC_TM_FEATURE_LAKE_VICTORIA_EFFECT",					"Qualquer Civilização que possua pelo menos um destes painéis recebe +15% de [ICON_FoodSurplus] Crescimento em cidades fora do continente da sua [ICON_Capital] Capital Original."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_VESUVIUS_EFFECT",					"Locais de Antiguidades recebem +4 de [ICON_CULTURE] Cultura, e [ICON_GREATWORK_ARTIFACT] Artefatos recebem +2 de [ICON_CULTURE] Cultura e +2 de [ICON_TOURISM] Turismo para qualquer Civilização que possua este painel."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_ZHANGYE_DANXIA_EFFECT",				"Centros Comerciais e Campus em Cidades que possuírem pelo menos um destes painéis recebem +2 Pontos de [ICON_GreatPerson] Grande Personalidade de seus tipos respectivos."	),
